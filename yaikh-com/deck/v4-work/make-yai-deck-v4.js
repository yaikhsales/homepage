...
const CONSTELLATION = [
  { s: "Ai Server", c: "aisrv", cols: 1, g: [] }, // left tower — content to come
...
.constslide h2{font-size:36px;margin-bottom:16px}.const{display:grid;grid-template-columns:2.2fr 10.6fr 3.2fr 6.4fr;gap:10px;align-items:stretch}.crow2{display:grid;grid-template-columns:3fr 5fr;gap:14px}.csec{border-radius:12px;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.12);overflow:hidden}.csec-h{display:flex;align-items:center;justify-content:center;text-align:center;height:58px;line-height:1.2;font-size:17px;font-weight:800;letter-spacing:.14em;text-transform:uppercase;padding:0 10px;color:#fff}.csec.admin .csec-h{background:var(--blue)}.csec.mgmt .csec-h{background:#6D28D9}.csec.aisrv .csec-h{background:var(--orange)}.csec.ops .csec-h{background:var(--green)}.ctabs{display:grid;gap:0;align-content:start}.ctab{padding:9px 7px 11px;border-top:1px solid rgba(255,255,255,.08)}.ctab b{display:block;font-size:19px;color:var(--gold);margin-bottom:4px}.ctab ul{margin:0;padding:0;list-style:none}.cprice{display:block;font-size:19px;font-weight:800;color:#fff;background:rgba(255,213,138,.14);border:1px dashed rgba(255,213,138,.55);border-radius:6px;padding:1px 8px;margin:0 0 4px;width:max-content;min-width:78px}.cprice.ghost{visibility:hidden}.ctab.stack ul{margin-bottom:12px}.ctab li{font-size:17px;line-height:1.3;hyphens:none;overflow-wrap:normal;color:#E6ECFA}
