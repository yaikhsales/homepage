...
export const SEED_SALARY_STORE: SalaryStore = {
  ...
  members: [
    ...
    // 2026-04: Khmer New Year bonus pool ($1,906 total — split per person: Daly $180, Dilan $300, Rich $170, Virot $170, Samnang $150, Seangleng $100, Yasomi $149, Alen $105, Chhay $110, Chetra $110, Khun $80, Menghorng $100, Sam $92, Phanny $90).
    { name: "Bonus pool (year-end / milestones)", status: "active", startMonth: "2024-05", monthly: { "2026-04": 1906 } },

    // ═══ GROUP 1 · Texlink Admin (BLUE) ══════════════════════════════════
    // HR · Sales · Admin · Training — 60% garment floor xp + 20% SW/Ai + 20% dual-role
    { name: "Pich Daly (Daly)",           status: "active", startMonth: "2026-01", group: "admin", groupRole: "lead",   monthly: { "2026-01": 929.00, "2026-02": 923.00, "2026-03": 923.02, "2026-04": 960.25, "2026-05": 900.00, "2026-06": 975.00 } },
    { name: "Koem Phanny (Phanny)",       status: "active", startMonth: "2025-01", group: "admin", groupRole: "member", monthly: { "2025-01": 237.00, "2025-02": 184.00, "2025-03": 237.00, "2025-04": 150.00, "2025-05": 176.00, "2025-06": 198.00, "2025-07": 200.00, "2025-08": 300.00, "2025-09": 271.00, "2025-10": 319.00, "2025-11": 256.00, "2025-12": 316.00, "2026-01": 469.84, "2026-02": 401.16, "2026-03": 454.60, "2026-04":  472.39, "2026-05":  450.00, "2026-06":  450.00 } },
    { name: "Sin Khun (Khun)",            status: "active", startMonth: "2026-01", group: "admin", groupRole: "member", monthly: { "2026-01": 401.13, "2026-02": 410.35, "2026-03": 378.94, "2026-04":  415.84, "2026-05":  400.00, "2026-06":  450.00 } },
    ...
    { name: "Van Phanith (Michael)",      status: "active", startMonth: "2025-10", group: "architecture", groupRole: "member", monthly: { "2025-10": 136.85, "2025-11": 281.35, "2025-12": 364.65, "2026-01": 410.19, "2026-02": 394.31, "2026-03": 394.98, "2026-04":  439.55, "2026-05": 400.00, "2026-06": 400.00 } },
    // Ton Naoun = "Sam" (alias). May 2026 = new $500 + $92 bonus.
    { name: "Ton Naoun (Sam)",            status: "active", startMonth: "2026-01", group: "architecture", groupRole: "member", monthly: { "2026-01": 467.83, "2026-02": 461.50, "2026-03": 471.02, "2026-04":  379.02, "2026-05": 460.00, "2026-06": 500.00 } },
    ...
    { name: "Van Virot (Virot)",          status: "active", startMonth: "2024-05", group: "neural-net", groupRole: "lead", monthly: {
      ...
      "2026-01": 866.96, "2026-02": 860.00, "2026-03": 861.02, "2026-04": 870.58, "2026-05": 850.00, "2026-06": 950.00,
    } },
    // 2025-01 ($33) + 2025-07 ($12) outliers replaced with row avg $133.50.
    // Resigning end of Jun 2026 — keeps group + colour while serving final month.
    { name: "Sobon Menghorng (Menghorng)", status: "resigned", startMonth: "2024-07", endMonth: "2026-06", group: "neural-net", groupRole: "member", monthly: { "2024-07":  65.25, "2024-08": 132.00, "2024-09": 115.50, "2024-10":  78.00, "2024-11":  52.50, "2024-12":  44.25, "2025-01": 133.50, "2025-02": 143.25, "2025-03": 133.50, "2025-04": 180.00, "2025-05": 210.00, "2025-06": 111.75, "2025-07": 133.50, "2025-08": 133.50, "2025-09": 133.50, "2025-10": 133.50, "2025-11": 133.50, "2025-12": 133.50, "2026-01": 517.02, "2026-02": 451.35, "2026-03": 511.02, "2026-04":  480.21, "2026-05":  500.00, "2026-06":  525.00 } },
    ...
    { name: "Keo Samnang (Samnang)",      status: "active", startMonth: "2024-07", group: "mobile-apps", groupRole: "lead", monthly: {
      ...
      "2026-01": 781.42, "2026-02": 731.50, "2026-03": 761.02, "2026-04": 810.46, "2026-05": 750.00, "2026-06": 850.00,
    } },
    ...
    { name: "DILAN LAKSHITHA LAKMAL (Dilan)", status: "active", startMonth: "2024-05", group: "ops-systems", groupRole: "lead", monthly: {
      ...
      "2026-01": 1429.46, "2026-02": 1520.00, "2026-03": 1540.00, "2026-04": 1864.70, "2026-05": 1500.00, "2026-06": 1850.00,
    } },
    ...
    { name: "Palayangodage Sampath Yasomi (Yasomi)", status: "active", startMonth: "2024-09", group: "ops-systems", groupRole: "member", monthly: {
      ...
      "2026-01": 716.00, "2026-02": 720.00, "2026-03": 740.00, "2026-04":  724.83, "2026-05":  700.00, "2026-06":  800.00,
    } },
    ...
    // Sophy: resigned end May 2026 — record kept for historic audit, excluded from active totals.
