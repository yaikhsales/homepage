...
`, { cls: "rdslide", eyebrowHtml: `<img class="eb-logo" src="${logo}" alt="">Yai Mobile Ai` });
    const KM_TEXT = [
      ...
      ["<p>Supports work functions and everyday tasks alike — reminders, searching clients, products and prices, answering from the factory's own data.</p>", '<p>AI ផ្ទាល់ខ្លួនសម្រាប់អ្នកប្រើប្រាស់គ្រប់រូប — ជួយការងារ និងកិច្ចការប្រចាំថ្ងៃ៖ ការរំលឹក ស្វែងរកអតិថិជន ផលិតផល និងតម្លៃ ឆ្លើយពីទិន្នន័យរបស់រោងចក្រផ្ទាល់។</p>'],
      ['<div class="rd-note-k">Supporting tools</div>', '<div class="rd-note-k">ឧបករណ៍ជំនួយ · Supporting tools</div>'],
      ['<p><b>Scan</b> — QR scanner for any QR need in Yai · <b>My Learn</b> — training, scores, credits · <b>My Requests</b> — support tickets and item requests · <b>Organizations</b> — own HR, ILO and Yai partner organizations.</p>', '<p><b>Scan</b> — ស្កេន QR កូដគ្រប់ប្រភេទក្នុង Yai · <b>My Learn</b> — ការបណ្តុះបណ្តាល ពិន្ទុ ក្រេឌីត · <b>My Requests</b> — សំណើជំនួយ និងសំណើសម្ភារៈ · <b>Organizations</b> — ធនធានមនុស្សផ្ទាល់ ILO និងអង្គការដៃគូរបស់ Yai។</p>'],
    ...
    const financials = slide("dark", "Financials · FY2025", `
<div class="fin-sub">Texlink Technologies Co., Ltd. · year ended 31 December 2025 · USD · source: IEWS FS1–FS3</div>
<div class="fin">
  <div class="fin-col">
...
<div class="fin-note"><b>2025 was a build year.</b> No sales revenue booked — the team's salaries were funded by Yorkwell Asia (US$15–17k / month). Paid subscriptions start Aug–Oct 2026 (Yorkmars, BICNZ, 3SGS, ES Packing).</div>
`);
...
.fin-sub{color:#8FA8D8;font-size:16px;margin:-6px 0 14px}.fin{display:grid;grid-template-columns:repeat(3,1fr);gap:22px;align-items:start}.fin-col h3{margin:0 0 6px;font-size:20px;color:var(--gold);letter-spacing:.04em}.fin-t{width:100%;border-collapse:collapse;margin:0;font-size:14px}.fin-t th{font-size:12px;color:#8FA8D8;font-weight:700;text-align:right;padding:2px 4px;border-bottom:1px solid rgba(255,255,255,.2);letter-spacing:.06em}.fin-t th:first-child{text-align:left}.fin-t td{background:none;border:0;border-bottom:1px solid rgba(255,255,255,.08);height:auto;padding:7px 4px;text-align:right;color:#DCE4F5;font-size:14px;font-variant-numeric:tabular-nums;white-space:nowrap}.fin-t td:first-child{text-align:left;color:#C7D2E6;white-space:normal}.fin-t tr.tot td{font-weight:700;color:#fff;border-top:1px solid rgba(255,255,255,.25)}.fin-t tr.net td{font-weight:800;color:var(--gold);border-top:2px solid var(--orange);border-bottom:0}.fin-note{margin-top:18px;padding:12px 18px;border-left:4px solid var(--orange);background:rgba(255,255,255,.05);font-size:17px;line-height:1.4;color:#DCE4F5}.fin-note b{color:var(--gold)}
/* footer signature */
