...
<div class="rd">
  ...
  <div class="rd-chat">
    ...
    <div class="rd-sec"><span class="rd-av coin"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M14.7 6.3a4 4 0 0 0-5.2 5.2L4 17l3 3 5.5-5.5a4 4 0 0 0 5.2-5.2l-2.4 2.4-2.1-.6-.6-2.1z"/></svg></span><div class="rd-bub">
      ...
      <h3>Services for factories — posted, ordered and paid in one place.</h3>
    ...
    <div class="rd-sec"><span class="rd-av coin"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M3 8l9-4 9 4-9 4z"/><path d="M3 8v9l9 4 9-4V8"/><path d="M12 12v9"/><path d="M7.5 6l9 4"/></svg></span><div class="rd-bub">
      ...
      <h3>Yai-operated wholesale market for factory purchasing.</h3>
    ...
    <div class="rd-sec"><span class="rd-av"><img src="${logo}" alt="Yai"></span><div class="rd-bub">
      ...
      <h3>A personal Ai for every user.</h3>
    ...
    <div class="rd-sec"><span class="rd-av coin blue"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16v16H4z"/><path d="M8 9h8M8 13h8M8 17h5"/></svg></span><div class="rd-bub">
      <div class="rd-note-k">Corporate Services · Production</div>
      <p>Used while at work — administrative functions (YACC, YHR, YADMIN, YCSR) and production functions (QMS, Call out, FC, CE, YTM, 4DP, YPI, MRP, shops). What each user can do changes with their job role.</p>
    </div></div>
  </div>
