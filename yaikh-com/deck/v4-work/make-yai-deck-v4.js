...
<section class="slide ${light ? "light" : "dark"} ${opts.cls || ""}" id="s${n}">
  ${eyebrow ? `<div class="eyebrow">${opts.eyebrowHtml || esc(eyebrow)}</div>` : ""}
  ${body}
...
`;
    ...
    <div class="hd"><span class="hd-av"><img src="${uri(path.join(LITE, "ui", "avatar-gamini.jpg"))}" alt=""></span><b>Gamini Ka</b><small>Texlink · TL02</small><span class="hd-sp"></span><span class="hd-ic">🔔</span><span class="hd-ic flag">🇬🇧</span><span class="hd-ic">＋</span></div>
...
${homeBody}
    ...
    const howItWorks = slide("dark", "", `

<div class="hiw">
  <figure class="hiw-web"><div class="hiw-t">Yai Web Ai</div><img src="${uri(path.join(LITE, "ui", "web-home-flat.jpg"))}" alt="Yai web UI">
    <div class="wchat">
      ...
      <div class="wc-in"><span>Ask Yai… KH / EN / 中文</span><i><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12l16-8-6 16-2-7z"/></svg></i></div>
    </div></figure>
  <figure class="hiw-app"><div class="hiw-t">Yai Mobile Ai</div><div class="hiw-mock">${homePhone}</div></figure>
  <div class="hiw-aiot"><div class="hiw-t">Yai AIoT</div><div class="hiw-grid">
...
`, { cls: "hiwslide" });
    ...
    const redesign = slide("dark", "Yai Mobile Ai", `
<div class="rd">
  <div class="rd-phones">${homePhone}</div>
  <div class="rd-chat">
    <div class="rd-sec"><span class="rd-av coin"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M4 5h16v14H4z"/><path d="M10 9l5 3-5 3z" fill="#fff" stroke="none"/></svg></span><div class="rd-bub">
      <div class="rd-note-k">Video feed</div>
      <p>Short clips on the home screen — TikTok-style, in Khmer. The company posts onboarding, safety, quality and HR notices; organizations post theirs — TAFTAC, brands, auditors, government. Yai tracks who watched and finished; workers earn training credits to claim Yai gifts.</p>
    </div></div>
    ...
    <div class="rd-sec"><span class="rd-av coin"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M3 8l9-4 9 4-9 4z"/><path d="M3 8v9l9 4 9-4V8"/><path d="M12 12v9"/><path d="M7.5 6l9 4"/></svg></span><div class="rd-bub">
      ...
      <p>Factories place large orders for non-production materials — admin consumables, spare parts, maintenance material; wholesale vendors join to supply them. Payments and deliveries go through official channels.</p>
    </div></div>
    <div class="rd-sec"><span class="rd-av"><img src="${logo}" alt="Yai"></span><div class="rd-bub">
      <div class="rd-note-k">My Yai</div>
      <p>Supports work functions and everyday tasks alike — reminders, searching clients, products and prices, answering from the factory's own data.</p>
    </div></div>
    <div class="rd-sec"><span class="rd-av coin"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M4 8V4h4M16 4h4v4M20 16v4h-4M8 20H4v-4"/><path d="M4 12h16"/></svg></span><div class="rd-bub">
      <div class="rd-note-k">Supporting tools</div>
      <p><b>Scan</b> — QR scanner for any QR need in Yai · <b>My Learn</b> — training, scores, credits · <b>My Requests</b> — support tickets and item requests · <b>Organizations</b> — own HR, ILO and Yai partner organizations.</p>
    </div></div>
    <div class="rd-sec"><span class="rd-av coin blue"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16v16H4z"/><path d="M8 9h8M8 13h8M8 17h5"/></svg></span><div class="rd-bub">
      <div class="rd-note-k">Corporate Services</div>
      <p>Used while at work for the various administrative functions — YACC, YHR, YADMIN, YCSR. Capabilities change depending on the job designation.</p>
    </div></div>
    <div class="rd-sec"><span class="rd-av coin green"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l7 3v6c0 4-3 7-7 9-4-2-7-5-7-9V6z"/><path d="M9 12l2 2 4-4"/></svg></span><div class="rd-bub">
      <div class="rd-note-k">Production</div>
      <p>Work-related production functions — QMS, Call out, FC, CE, YTM, 4DP, YPI, MRP, YM Shop, YTM Shop. Same as Admin: what each user sees differs by job role.</p>
    </div></div>
  </div>
...
${homeBody}
    <div class="ssep green"><span>Production</span></div>
    <div class="srow srow3">
      <div class="stile"><i class="sico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l7 3v6c0 4-3 7-7 9-4-2-7-5-7-9V6z"/><path d="M9 12l2 2 4-4"/></svg></i><span>QMS</span></div>
      <div class="stile"><i class="sico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M5 4h4l2 5-2.5 1.5a11 11 0 0 0 5 5L15 13l5 2v4a2 2 0 0 1-2 2A16 16 0 0 1 3 6a2 2 0 0 1 2-2z"/></svg></i><span>Call out</span></div>
      <div class="stile"><i class="sico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 20V10M10 20V4M16 20v-7M22 20H2"/></svg></i><span>FC</span></div>
      <div class="stile"><i class="sico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 6h16v12H4z"/><path d="M8 10h8M8 14h5"/><path d="M4 6l4 4"/></svg></i><span>CE</span></div>
      <div class="stile"><i class="sico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 17l6-6 4 4 8-8"/><path d="M15 7h6v6"/></svg></i><span>YTM</span></div>
      <div class="stile"><i class="sico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16v16H4z"/><path d="M4 12h16M12 4v16"/></svg></i><span>4DP</span></div>
      <div class="stile"><i class="sico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="8"/><path d="M12 4v8l5 3"/></svg></i><span>YPI</span></div>
      <div class="stile"><i class="sico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 8l9-4 9 4-9 4z"/><path d="M3 8v9l9 4 9-4V8"/><path d="M12 12v9"/></svg></i><span>MRP</span></div>
      <div class="stile"><i class="sico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 9h16l-1 11H5z"/><path d="M9 9V6a3 3 0 0 1 6 0v3"/></svg></i><span>YM SHOP</span></div>
      <div class="stile"><i class="sico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 4h2l2 12h11l2-8H7"/><circle cx="9" cy="20" r="1.5"/><circle cx="17" cy="20" r="1.5"/></svg></i><span>YTM SHOP</span></div>
    </div>
    </div></div>
    <div class="snav">
      <div class="sn on"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 11l9-7 9 7"/><path d="M5 10v10h14V10"/><path d="M10 20v-6h4v6"/></svg><span>Home</span></div>
...
`, { cls: "rdslide", eyebrowHtml: `<img class="eb-logo" src="${logo}" alt="">Yai Mobile Ai` });
    const KM_TEXT = [
      ['<div class="rd-note-k">Video feed</div>', '<div class="rd-note-k">វីដេអូ · Video feed</div>'],
      ['<p>Short clips on the home screen — TikTok-style, in Khmer. The company posts onboarding, safety, quality and HR notices; organizations post theirs — TAFTAC, brands, auditors, government. Yai tracks who watched and finished; workers earn training credits to claim Yai gifts.</p>', '<p>វីដេអូខ្លីៗនៅលើអេក្រង់ដើម — បែប TikTok ជាភាសាខ្មែរ។ ក្រុមហ៊ុនបង្ហោះការណែនាំបុគ្គលិកថ្មី សុវត្ថិភាព គុណភាព និងសេចក្តីជូនដំណឹងធនធានមនុស្ស; អង្គការនានាក៏បង្ហោះដែរ — TAFTAC ម៉ាកយីហោ សវនករ រដ្ឋាភិបាល។ Yai តាមដានអ្នកបានមើល និងបានបញ្ចប់; កម្មករទទួលក្រេឌីតបណ្តុះបណ្តាល ដើម្បីទទួលអំណោយ Yai។</p>'],
      ['<div class="rd-note-k">Phsar Market · <span class="km">ផ្សារ</span></div>', '<div class="rd-note-k">ផ្សារ · Phsar Market</div>'],
      ['<p>Users post their own products — farm produce, home-made food, handicraft, local goods. Buyers in Cambodia and overseas browse and order; Yai handles listing, chat and delivery. Payment and order handling fully secured through ABA and Wing.</p>', '<p>អ្នកប្រើប្រាស់បង្ហោះផលិតផលរបស់ខ្លួន — ផលកសិកម្ម អាហារធ្វើនៅផ្ទះ សិប្បកម្ម ទំនិញក្នុងស្រុក។ អ្នកទិញក្នុងប្រទេស និងក្រៅប្រទេសរកមើល និងបញ្ជាទិញ; Yai គ្រប់គ្រងការចុះបញ្ជី ការជជែក និងការដឹកជញ្ជូន។ ការទូទាត់ និងការបញ្ជាទិញមានសុវត្ថិភាពពេញលេញតាមរយៈ ABA និង Wing។</p>'],
      ['<div class="rd-note-k">Service Market</div>', '<div class="rd-note-k">ផ្សារសេវាកម្ម · Service Market</div>'],
      ['<p>Service providers post their services — machine repair, calibration, transport, cleaning, catering, training. Factories order in the app; providers take the order and get paid securely.</p>', '<p>អ្នកផ្តល់សេវាកម្មបង្ហោះសេវាកម្មរបស់ខ្លួន — ជួសជុលម៉ាស៊ីន ការក្រិតតាមខ្នាត ដឹកជញ្ជូន សម្អាត ម្ហូបអាហារ បណ្តុះបណ្តាល។ រោងចក្របញ្ជាទិញក្នុងកម្មវិធី; អ្នកផ្តល់សេវាទទួលការបញ្ជាទិញ និងទទួលប្រាក់ដោយសុវត្ថិភាព។</p>'],
      ['<div class="rd-note-k">Factory Supply Market</div>', '<div class="rd-note-k">ផ្សារផ្គត់ផ្គង់រោងចក្រ · Factory Supply</div>'],
      ['<p>Factories place large orders for non-production materials — admin consumables, spare parts, maintenance material; wholesale vendors join to supply them. Payments and deliveries go through official channels.</p>', '<p>រោងចក្របញ្ជាទិញចំនួនច្រើននូវសម្ភារៈមិនមែនផលិតកម្ម — សម្ភារៈរដ្ឋបាល គ្រឿងបន្លាស់ សម្ភារៈថែទាំ; អ្នកលក់ដុំចូលរួមផ្គត់ផ្គង់។ ការទូទាត់ និងការដឹកជញ្ជូនធ្វើឡើងតាមបណ្តាញផ្លូវការ។</p>'],
      ['<div class="rd-note-k">My Yai</div>', '<div class="rd-note-k">My Yai · AI ផ្ទាល់ខ្លួន</div>'],
      ["<p>Supports work functions and everyday tasks alike — reminders, searching clients, products and prices, answering from the factory's own data.</p>", '<p>AI ផ្ទាល់ខ្លួនសម្រាប់អ្នកប្រើប្រាស់គ្រប់រូប — ជួយការងារ និងកិច្ចការប្រចាំថ្ងៃ៖ ការរំលឹក ស្វែងរកអតិថិជន ផលិតផល និងតម្លៃ និងឆ្លើយសំណួរដោយផ្អែកលើទិន្នន័យផ្ទាល់ខ្លួនរបស់រោងចក្រ។</p>'],
      ['<div class="rd-note-k">Supporting tools</div>', '<div class="rd-note-k">ឧបករណ៍ជំនួយ · Supporting tools</div>'],
      ['<p><b>Scan</b> — QR scanner for any QR need in Yai · <b>My Learn</b> — training, scores, credits · <b>My Requests</b> — support tickets and item requests · <b>Organizations</b> — own HR, ILO and Yai partner organizations.</p>', '<p><b>Scan</b> — ស្កេន QR កូដគ្រប់ប្រភេទសម្រាប់ប្រើក្នុង Yai · <b>My Learn</b> — ការបណ្តុះបណ្តាល ពិន្ទុ ក្រេឌីត · <b>My Requests</b> — សំណើជំនួយ និងសំណើសម្ភារៈ · <b>Organizations</b> — នាយកដ្ឋានធនធានមនុស្សផ្ទាល់ខ្លួន ILO និងអង្គការដៃគូរបស់ Yai។</p>'],
      ['<div class="rd-note-k">Corporate Services</div>', '<div class="rd-note-k">សេវាកម្មសាជីវកម្ម · Corporate Services</div>'],
      ['<p>Used while at work for the various administrative functions — YACC, YHR, YADMIN, YCSR. Capabilities change depending on the job designation.</p>', '<p>ប្រើនៅកន្លែងធ្វើការសម្រាប់មុខងាររដ្ឋបាលផ្សេងៗ — YACC, YHR, YADMIN, YCSR។ សមត្ថភាពប្រែប្រួលតាមតួនាទីការងារ។</p>'],
      ['<div class="rd-note-k">Production</div>', '<div class="rd-note-k">ផលិតកម្ម · Production</div>'],
      ['<p>Work-related production functions — QMS, Call out, FC, CE, YTM, 4DP, YPI, MRP, YM Shop, YTM Shop. Same as Admin: what each user sees differs by job role.</p>', '<p>មុខងារផលិតកម្ម — QMS, Call out, FC, CE, YTM, 4DP, YPI, MRP, YM Shop, YTM Shop។ ដូច Admin ដែរ៖ អ្វីដែលអ្នកប្រើម្នាក់ៗឃើញខុសគ្នាតាមតួនាទី។</p>']
    ];
...
<div class="fin">
  <div class="fin-col">
    ...
    <table class="fin-t"><thead><tr><th></th><th>Oct–Dec 25</th><th>Jan–Aug 26</th></tr></thead><tbody>
      ...
      ${finRow("Fuel, electricity, water", "69.13", "1,850.00")}
      ${finRow("Bank charge", "15.11", "120.00")}
  ...
  <div class="fin-col">
    ...
    <table class="fin-t"><thead><tr><th></th><th>Oct–Dec 25</th><th>Jan–Aug 26</th></tr></thead><tbody>
      ...
      ${finRow("Ai server, Macs, screens", "–", "(10,750.00)")}
      ${finRow("Net cash used in investing", "(1,217.87)", "(10,750.00)", "tot")}
      ${finRow("Issuance of share capital", "59,190.21", "–")}
      ${finRow("Net cash from financing", "59,190.21", "–", "tot")}
      ${finRow("Net change in cash", "56,620.54", "(9,553.33)")}
      ${finRow("Cash at start of period", "–", "56,620.54")}
      ${finRow("Cash at end of period", "56,620.54", "47,067.21", "net")}
    </tbody></table>
  </div>
</div>
`);
    const KM_UI = [
      ['<span>Today</span>', '<span>ថ្ងៃនេះ</span>'],
      ['<span>Weekly 14:52 h</span>', '<span>សប្តាហ៍ 14:52 ម៉ោង</span>'],
      ['<span>6.5 d</span>', '<span>6.5 ថ្ងៃ</span>'],
      ['<small>Phsar Market</small><em>128 shops</em>', '<small>ផ្សារ</small><em>ហាង 128</em>'],
      ['<small>Service Market</small><em>3 requests</em>', '<small>ផ្សារសេវាកម្ម</small><em>សំណើ 3</em>'],
      ['<small>Factory Supply Market</small><em>2 orders</em>', '<small>ផ្សារផ្គត់ផ្គង់រោងចក្រ</small><em>ការបញ្ជាទិញ 2</em>'],
      ['<small>My Yai</small><em>ask me</em>', '<small>Yai របស់ខ្ញុំ</small><em>សួរខ្ញុំ</em>'],
      ['<span>Scan</span>', '<span>ស្កេន</span>'],
      ['<span>My Learn</span>', '<span>ការសិក្សា</span>'],
      ['<span>My Requests</span>', '<span>សំណើរបស់ខ្ញុំ</span>'],
      ['<span>Organizations</span>', '<span>អង្គការ</span>'],
      ['<span>Corporate Services</span>', '<span>សេវាកម្មសាជីវកម្ម</span>'],
      ['<span>Production</span>', '<span>ផលិតកម្ម</span>'],
      ['<span>Home</span>', '<span>ទំព័រដើម</span>'],
      ['<span>Services</span>', '<span>សេវាកម្ម</span>'],
      ['<span>My Yai</span>', '<span>Yai របស់ខ្ញុំ</span>'],
      ['<span>Profile</span>', '<span>ប្រវត្តិរូប</span>'],
      ['@yaikh2025 · Ai for garment factory', '@yaikh2025 · Ai សម្រាប់រោងចក្រកាត់ដេរ'],
      ['Run your factory from your phone', 'គ្រប់គ្រងរោងចក្រពីទូរស័ព្ទរបស់អ្នក'],
      ['<b>Share</b>', '<b>ចែករំលែក</b>'],
      ['<span class="hd-ic flag">🇬🇧</span>', '<span class="hd-ic flag">🇰🇭</span>']
    ];
    for (const [en, km] of KM_UI) redesignKm = redesignKm.split(en).join(km);
    const handSide = {
      1: { l: `<h3>Outside</h3><p>The face of the brochure — the three panels a visitor sees first.</p><ul><li><b>Who it serves</b> — worker, supervisor, manager, owner, buyer, government</li><li><b>Price</b> — Starter $120 · Growth $750 · Enterprise $1,200 a year</li><li><b>Cover</b> — Yai, Ai-Native Manufacturing Intelligence, contacts and QR</li></ul>`,
           r: `<h3>Where it goes</h3><p>Printed A4 tri-fold, handed out at factory visits, TAFTAC events and expos — Khmer, English and Chinese on one sheet.</p>` },
      2: { l: `<h3>Inside</h3><p>Opens to the full picture in one spread.</p><ul><li><b>The problem</b> — brands, government, society, ASEAN</li><li><b>70+ multi-platform apps</b> — the module map by department, trilingual</li><li><b>14 Ai agents</b> — one per department, all on the same data</li></ul>`,
           r: `<h3>Scan to see it live</h3><p>yaikh.com/experience — the web app, the phone app and the AIoT dashboards, no login needed.</p>` },
    };
    const handout = (k) => slide("dark", "Handout · Tri-fold brochure", `<div class="hand"><div class="hand-side">${handSide[k].l}</div><img src="${uri(path.join(LITE, "brochure", "page-" + k + ".jpg"))}" alt="Yai tri-fold brochure, page ${k}"><div class="hand-side r">${handSide[k].r}<img class="hand-qr" src="${uri(path.join(LITE, "gamini-telegram-qr.png"))}" alt=""><small>Telegram · Gamini</small></div></div>`);
...
.rdslide .eyebrow{margin:0 0 10px -44px;display:flex;align-items:center;gap:14px}.eb-logo{width:40px;height:40px;border-radius:50%;object-fit:cover;box-shadow:0 3px 8px rgba(0,0,0,.4)}.rd{display:flex;justify-content:space-between;margin:0 -44px;gap:26px;align-items:flex-start}.rd-phones{width:320px}.rd-chat{flex:1;align-self:flex-start;padding:0 6px;margin-top:-46px;font-family:Arial,Helvetica,sans-serif;display:flex;flex-direction:column;gap:4px}.rd-sec{display:flex;align-items:flex-start;gap:10px}.rd-av{width:40px;height:40px;border-radius:50%;overflow:hidden;flex:none;box-shadow:0 3px 8px rgba(0,0,0,.4);margin-top:4px}.rd-av.coin{background:radial-gradient(circle at 35% 30%,#FF9A5C 0%,#F37021 45%,#C4501A 100%);display:flex;align-items:center;justify-content:center;color:#fff}.rd-av.coin.blue{background:#1E3A8A}.rd-av.coin.green{background:#166534}.rd-av.coin svg{width:22px;height:22px;display:block;stroke:currentColor;fill:none;filter:drop-shadow(0 1px 1px rgba(0,0,0,.35))}.rd-av img{width:100%;height:100%;object-fit:cover;display:block;border:0;box-shadow:none;border-radius:50%}.rd-bub{position:relative;background:#F6F5F2;color:#0A1F47;border-radius:18px;border-top-left-radius:4px;padding:6px 12px 7px;box-shadow:0 8px 24px rgba(0,0,0,.35)}.rd-bub::before{content:"";position:absolute;left:-8px;top:10px;border:8px solid transparent;border-right-color:#F6F5F2;border-left:0}.rd-note-k{color:var(--orange);font-weight:700;font-size:11px;letter-spacing:2px;text-transform:uppercase;margin-bottom:2px}h3 .rd-note-k{display:inline;margin:0 8px 0 0;font-size:11px;vertical-align:1px}.rd-note-k .km{font-family:"Khmer Sangam MN","Noto Sans Khmer","Khmer OS",sans-serif;letter-spacing:0;font-size:16px;text-transform:none}.rd-chat h3{font-size:14px;line-height:1.18;margin:0 0 2px;color:#0A1F47}.rd-chat p{font-size:12px;line-height:1.34;margin:0;color:#334155}.rd-chat p b{color:#0A1F47}.rdkm .rd-chat p{font-family:"Khmer Sangam MN","Khmer OS","Noto Sans Khmer",Arial,sans-serif;font-size:10.5px;line-height:1.48}.rdkm .rd-chat{gap:3px}.rdkm .phone.big .scr, .rdkm .phone.big .scr *{font-family:"Khmer Sangam MN","Khmer OS","Noto Sans Khmer",Arial,sans-serif}.rdkm .stile{font-size:9px}.rdkm .srow3 .stile{font-size:8.5px}.rdkm .snav{font-size:9.5px}.rdkm .vb small{font-size:8.5px}.rdkm .rd-bub{padding:5px 12px 6px}.rdkm .rd-note-k{font-family:"Khmer Sangam MN","Khmer OS","Noto Sans Khmer",Arial,sans-serif;letter-spacing:.5px;text-transform:none;font-size:12px}.phone.big{height:auto;padding:12px 10px;box-sizing:border-box}.scr{width:300px;border-radius:22px;overflow:hidden;background:#f6f6f6}.scr img{display:block;width:300px;border:0;box-shadow:none;border-radius:0}
.hd{display:flex;align-items:center;gap:6px;padding:10px 12px 4px;font-family:Arial,Helvetica,sans-serif;color:#0A1F47}.hd b{font-size:14px}.hd small{font-size:10px;color:#94A3B8}.hd-sp{flex:1}.hd-av{width:26px;height:26px;border-radius:50%;overflow:hidden;background:linear-gradient(135deg,#F37021,#FFD58A);flex:none}.hd-av img{width:100%;height:100%;object-fit:cover;display:block;border:0;box-shadow:none;border-radius:50%}.hd-ic{width:24px;height:24px;border-radius:50%;background:#EEECE7;display:flex;align-items:center;justify-content:center;font-size:11px}.hd-ic.flag{font-size:14px}.hd2{display:flex;align-items:center;gap:5px;padding:2px 12px 6px;font-size:9.5px;color:#64748B;font-family:Arial,Helvetica,sans-serif;white-space:nowrap}.hd2 em{font-style:normal;color:#CBD5E1}.hd-bar{width:54px;height:5px;border-radius:3px;background:#E8E6E1;overflow:hidden}.hd-bar i{display:block;width:0;height:100%;background:var(--orange)}.scr-bot{height:auto}.ssep{display:flex;align-items:center;gap:6px;padding:8px 10px 2px;background:#F6F5F2;font:700 10px Arial,Helvetica,sans-serif;color:var(--orange);letter-spacing:.3px;white-space:nowrap}.ssep::before,.ssep::after{content:"";flex:1;height:2px;background:var(--orange);border-radius:1px}.srow{display:grid;grid-template-columns:repeat(4,1fr);gap:6px;padding:8px 10px 0;background:#F6F5F2}.stile{background:#fff;border-radius:12px;height:66px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:5px;font:700 10px Arial,Helvetica,sans-serif;color:#0A1F47;box-shadow:0 1px 3px rgba(10,31,71,.06)}.stile img{width:34px;height:auto;display:block;border:0;box-shadow:none;border-radius:0}.sico{width:32px;height:32px;border-radius:50%;background:radial-gradient(circle at 35% 30%,#FF9A5C 0%,#F37021 45%,#C4501A 100%);box-shadow:0 3px 7px rgba(10,31,71,.3),inset 0 -2px 4px rgba(0,0,0,.25),inset 0 2px 3px rgba(255,255,255,.35);color:#fff;display:flex;align-items:center;justify-content:center}.sico svg{width:18px;height:18px;display:block;stroke:currentColor;fill:none;filter:drop-shadow(0 1px 1px rgba(0,0,0,.35))}.scr-nav{height:auto}.srow2{padding:6px 10px 10px}.srow2 .sico{width:40px;height:40px;background:#1E3A8A;box-shadow:none}.srow2 .sico svg{width:22px;height:22px;filter:none}.snav{display:grid;grid-template-columns:repeat(4,1fr);height:52px;background:#fff;border-top:1px solid #E8E6E1;font:600 10.5px Arial,Helvetica,sans-serif;color:#64748B}.sn{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:3px}.sn svg{width:20px;height:20px;display:block;stroke:currentColor;fill:none}.sn.on{color:var(--orange)}.sn img{width:22px;height:22px;border-radius:50%;object-fit:cover;display:block;border:0;box-shadow:none}.scr.chat{display:flex;flex-direction:column;height:576px;box-sizing:border-box;background:#F6F5F2}.hd-yai{width:26px;height:26px;border-radius:50%;overflow:hidden;box-shadow:0 2px 5px rgba(10,31,71,.3)}.hd-yai img{width:100%;height:100%;object-fit:cover;display:block;border:0;box-shadow:none;border-radius:50%}.scr.chat .hd{padding:10px 12px 8px;border-bottom:1px solid #E8E6E1;background:#fff}.scr.chat .hd b{font-size:12px}.scr.chat .hd small{font-size:8px}.cbody{flex:1;padding:8px 10px;display:flex;flex-direction:column;gap:6px;font:9px/1.35 Arial,Helvetica,sans-serif;color:#0A1F47;overflow:hidden}.cday{text-align:center;font-size:7.5px;color:#94A3B8;margin-bottom:2px}.cb{max-width:82%;padding:6px 8px;border-radius:11px;box-shadow:0 1px 2px rgba(10,31,71,.08)}.cb.me{align-self:flex-end;background:var(--orange);color:#fff;border-bottom-right-radius:3px}.cb.ai{align-self:flex-start;background:#fff;border-bottom-left-radius:3px}.cb.ai b{color:#0A1F47}.ccard{background:#F6F5F2;border:1px solid #E8E6E1;border-radius:8px;padding:5px 7px;margin:2px 0 5px;font-size:8px}.cc-h{font-weight:700;color:var(--orange);margin-bottom:3px}.cc-row{display:flex;justify-content:space-between;gap:6px;padding:1px 0;color:#64748B}.cc-row b{color:#0A1F47;text-align:right}.cc-row b.warn{color:#DC2626}.cin{display:flex;align-items:center;gap:6px;padding:6px 10px;background:#fff;border-top:1px solid #E8E6E1;font:8.5px Arial,Helvetica,sans-serif;color:#94A3B8}.cin-mic{font-size:12px}.cin-box{flex:1;background:#F6F5F2;border-radius:14px;padding:6px 10px}.cin-send{width:24px;height:24px;border-radius:50%;background:radial-gradient(circle at 35% 30%,#FF9A5C 0%,#F37021 45%,#C4501A 100%);display:flex;align-items:center;justify-content:center;color:#fff}.cin-send svg{width:13px;height:13px;stroke:currentColor;fill:none}.scr.chat .snav{flex:none}.scr.up{display:flex;flex-direction:column;height:554px;box-sizing:border-box}.scr.up .hd{background:#F6F5F2;position:relative;z-index:2;box-shadow:0 2px 6px rgba(10,31,71,.08)}.sroll{flex:1;overflow:hidden;background:#F6F5F2}.sroll-in{margin-top:-172px}.scr.up .snav{flex:none}.xh{padding:10px 10px 5px;font:700 10px Arial,Helvetica,sans-serif;color:#0A1F47;display:flex;justify-content:space-between;align-items:baseline}.xh em{font-style:normal;color:var(--orange);font-weight:600;font-size:8.5px}.xlist{display:grid;grid-template-columns:1fr 1fr;gap:6px;padding:0 10px}.xrow{background:#fff;border-radius:10px;padding:6px 8px;display:flex;align-items:center;gap:7px;font:700 8.5px Arial,Helvetica,sans-serif;color:#0A1F47;box-shadow:0 1px 3px rgba(10,31,71,.06)}.sico.sm{width:22px;height:22px;flex:none}.ssep.green{color:#15803D}.ssep.green::before,.ssep.green::after{background:#16A34A}.srow3{grid-template-columns:repeat(5,1fr);gap:5px;padding:6px 8px 10px}.srow3 .stile{height:63px;font-size:9px;gap:4px;border-radius:10px}.srow3 .sico{width:35px;height:35px;background:#166534;box-shadow:none}.srow3 .sico svg{width:20px;height:20px;filter:none}.sico.sm svg{width:12px;height:12px}.xban{margin:8px 10px 0;padding:8px 10px;border-radius:10px;background:linear-gradient(135deg,#0A1F47,#1E3A8A);color:#fff;display:flex;flex-direction:column;gap:2px;font-family:Arial,Helvetica,sans-serif}.xban b{font-size:9.5px}.xban span{font-size:7.5px;color:#BFD0F5}
.vid-row{display:grid;grid-template-columns:auto 1fr;gap:6px;padding:6px 8px 4px;align-items:stretch}.vid{height:258px;width:144.4px;background:#0A1F47;border-radius:10px;position:relative;display:flex;align-items:center;justify-content:center;overflow:hidden}.vid-bg{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;display:block;border:0;box-shadow:none;border-radius:0}.vid-holder{background:linear-gradient(160deg,#0A1F47,#1E4DAA);display:flex;flex-direction:column;align-items:center;justify-content:flex-start;padding-top:18px;gap:2px;color:#FFD58A;text-align:center}.vid-holder span{font-size:8px;font-weight:700}.vid-holder small{font-size:6.5px;color:#8FA8D8}.vid-side{position:absolute;right:5px;bottom:46px;display:flex;flex-direction:column;gap:7px;align-items:center;color:#fff;font-size:11px;text-shadow:0 1px 2px rgba(0,0,0,.6)}.vid-side span{display:flex;flex-direction:column;align-items:center;gap:1px;line-height:1}.vid-side b{font-size:7px;font-weight:700}.vid-meta{position:absolute;left:6px;right:30px;bottom:8px;color:#fff;text-shadow:0 1px 2px rgba(0,0,0,.7);display:flex;flex-direction:column;gap:2px}.vid-meta b{font-size:8px}.vid-meta span{font-size:7.5px;line-height:1.25}.vid:after{content:"";position:absolute;inset:0;background:linear-gradient(to top,rgba(0,0,0,.55),transparent 45%)}.vid-side,.vid-meta,.vid-play{z-index:2}.vid-play{width:32px;height:32px;font-size:14px;border-radius:50%;background:rgba(255,255,255,.85);color:var(--orange);font-size:18px;display:flex;align-items:center;justify-content:center;padding-left:3px}.vid-cap{position:absolute;bottom:6px;left:6px;right:6px;font-size:7px;color:#FFD58A;text-align:center}
.vcol{display:flex;flex-direction:column;justify-content:space-around}.vb{display:flex;flex-direction:column;align-items:center;gap:1px}.vb{gap:0}.vb .vb-ic{width:36px;height:36px;border-radius:50%;background:radial-gradient(circle at 35% 30%,#FF9A5C 0%,#F37021 45%,#C4501A 100%);box-shadow:0 3px 7px rgba(10,31,71,.35),inset 0 -2px 4px rgba(0,0,0,.25),inset 0 2px 3px rgba(255,255,255,.35);display:flex;align-items:center;justify-content:center;color:#fff}.vb .vb-ic svg{width:19px;height:19px;display:block;stroke:currentColor;fill:none;filter:drop-shadow(0 1px 1px rgba(0,0,0,.35))}.vb.hot .vb-ic.yai{background:none;box-shadow:0 3px 7px rgba(10,31,71,.35);border-radius:50%;overflow:hidden;padding:0}.vb.hot .vb-ic.yai img{width:100%;height:100%;object-fit:cover;display:block;border:0;box-shadow:none;border-radius:50%}.vb small{font-size:9px;font-weight:700;color:#0A1F47;margin-top:3px;white-space:nowrap}.vb em{font-style:normal;font-size:8px;color:#94A3B8}.rd h2{font-size:38px;margin:0 0 16px}.rd ul{margin:0;padding-left:22px;font-size:20px;line-height:1.45;color:#DCE4F5}.rd li{margin-bottom:9px}.rd li b{color:var(--gold)}.rd-note{margin:18px 0 0;font-size:16px;color:#8FA8D8}
...
.hiwslide .eyebrow{margin-bottom:14px;letter-spacing:.1em;white-space:nowrap}.hiw{display:grid;grid-template-columns:auto 320px 1fr;gap:18px;align-items:start;margin:0 -48px}.hiw figure{margin:0}.hiw img{display:block;border-radius:10px;border:2px solid rgba(255,255,255,.18);box-shadow:0 10px 30px rgba(0,0,0,.4)}.hiw-web img{width:auto;height:585px;border-left:0;display:block}.hiw-web{position:relative}.wchat{position:absolute;right:10px;bottom:0;width:215px;background:#fff;border-radius:12px;box-shadow:0 12px 30px rgba(0,0,0,.45);font-family:Arial,Helvetica,sans-serif;color:#0A1F47;overflow:hidden;display:flex;flex-direction:column}.wc-hd{display:flex;align-items:center;gap:6px;padding:7px 10px;background:#0A1F47;color:#fff}.wc-hd img{width:22px;height:22px;border-radius:50%;object-fit:cover;border:0;box-shadow:none;display:block}.wc-hd b{font-size:11px}.wc-hd small{font-size:7.5px;color:#8FA8D8;flex:1}.wc-hd span{font-size:10px;color:#8FA8D8}.wc-body{padding:8px;display:flex;flex-direction:column;gap:5px;background:#F6F5F2;font-size:8.5px;line-height:1.3}.wc{max-width:86%;padding:5px 7px;border-radius:9px;box-shadow:0 1px 2px rgba(10,31,71,.08)}.wc.me{align-self:flex-end;background:var(--orange);color:#fff;border-bottom-right-radius:2px}.wc.ai{align-self:flex-start;background:#fff;border-bottom-left-radius:2px;color:#334155}.wc.ai b{color:#0A1F47}.wc-card{background:#F6F5F2;border:1px solid #E8E6E1;border-radius:6px;padding:4px 6px;margin:1px 0 4px;font-size:7.5px;display:flex;flex-direction:column;gap:1px}.wc-card span{font-weight:700;color:var(--orange)}.wc-card i{font-style:normal;display:flex;justify-content:space-between;color:#64748B}.wc-card i b{color:#0A1F47}.wc-card b.warn{color:#DC2626}.wc-in{display:flex;align-items:center;gap:6px;padding:6px 8px;background:#fff;border-top:1px solid #E8E6E1;font-size:8px;color:#94A3B8}.wc-in span{flex:1;background:#F6F5F2;border-radius:10px;padding:5px 8px}.wc-in i{width:20px;height:20px;border-radius:50%;background:var(--orange);display:flex;align-items:center;justify-content:center;color:#fff}.wc-in svg{width:11px;height:11px;stroke:currentColor;fill:none}.hiw-mock{width:320px;height:600px;transform:scale(.975);transform-origin:top center;margin:0 auto}.hiw-mock .phone.big{width:320px}.hiw figcaption{margin-top:8px;font-size:16px;line-height:1.3;color:#DCE4F5}.hiw figcaption b{display:block;color:var(--gold);font-size:19px;margin-bottom:2px}.hiw-aiot{border:0;padding:0 12px 12px;height:585px;margin-top:0;display:flex;flex-direction:column;gap:6px}.hiw-t{font-size:24px;font-weight:800;color:var(--gold);letter-spacing:.14em;text-transform:uppercase;margin:0 0 10px;white-space:nowrap;text-align:center}.hiw-aiot .hiw-t{margin:0 0 4px}.phone{position:relative;background:#111827;border-radius:34px;padding:14px 10px;height:585px;box-sizing:border-box;box-shadow:0 14px 34px rgba(0,0,0,.5),inset 0 0 0 2px #2a3446;width:100%;margin:0 auto}.phone-notch{position:absolute;top:8px;left:50%;transform:translateX(-50%);width:34%;height:14px;background:#111827;border-radius:0 0 12px 12px;z-index:2}.phone img{display:block;box-shadow:none;border:0}.hiw-grid{display:grid;grid-template-columns:1fr 1fr;gap:8px;flex:1;min-height:0}.hiw-aiot figure{margin:0;min-height:0;display:flex;flex-direction:column}.hiw-aiot figure img{flex:1;min-height:0;width:100%;object-fit:contain;background:#fff;border-radius:8px;border:1px solid rgba(255,255,255,.14)}.hiw-aiot figcaption{font-size:13px;color:#DCE4F5;margin-top:3px;text-align:center;white-space:nowrap}.hiw-aiot p{margin:0;font-size:15px;color:#8FA8D8;line-height:1.3}
...
.hand{display:grid;grid-template-columns:1fr auto 1fr;gap:22px;align-items:center;margin:-6px -30px 0}.hand>img{height:590px;width:auto;border-radius:8px;box-shadow:0 12px 30px rgba(0,0,0,.45);display:block}.hand-side{font-family:Arial,Helvetica,sans-serif;color:#DCE4F5}.hand-side h3{margin:0 0 8px;font-size:22px;color:var(--gold)}.hand-side p{margin:0 0 10px;font-size:15px;line-height:1.45}.hand-side ul{margin:0;padding-left:18px;font-size:14.5px;line-height:1.5}.hand-side li b{color:#fff}.hand-side.r{text-align:center}.hand-side.r h3,.hand-side.r p{text-align:left}.hand-qr{width:120px;height:120px;border-radius:10px;background:#fff;padding:6px;box-sizing:border-box;display:block;margin:14px auto 6px}.hand-side small{font-size:12px;color:#8FA8D8}
/* footer signature */
