...
export const SEED_SALARY_STORE: SalaryStore = {
  ...
  members: [
    ...
    // Van Virot: 2025 Jan-Mar @ $554, Apr+ @ $850 (53.43% raise).
    { name: "Van Virot",                  status: "active", startMonth: "2024-05", monthly: {
    ...
    { name: "Keo Samnang",                status: "active", startMonth: "2024-07", monthly: {
    ...
    { name: "Chhang Mengchhay",           status: "active", startMonth: "2024-08", monthly: {
    ...
    // Chhim Seangleng: 2025 all months @ $500 (no raise April 2025).
    { name: "Chhim Seangleng",            status: "active", startMonth: "2024-08", monthly: {
