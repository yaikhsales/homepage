...
<div class="rd">
  ...
  <div class="rd-chat">
    ...
    <div class="rd-sec"><span class="rd-av"><img src="${logo}" alt="Yai"></span><div class="rd-bub">
      ...
      <p>Providers post the services they offer factories — machine repair, calibration, transport, cleaning, catering, training. Factories order in the app; providers take the order and get paid securely.</p>
    </div></div>
    <div class="rd-sec"><span class="rd-av"><img src="${logo}" alt="Yai"></span><div class="rd-bub">
    ...
    <div class="rd-sec"><span class="rd-av"><img src="${logo}" alt="Yai"></span><div class="rd-bub">
      ...
      <p><b>Scan</b> — QR code scanner for any QR need in Yai · <b>My Learn</b> — training, scores and credits · <b>My Requests</b> — support tickets and item requests · <b>Organizations</b> — links to the worker's own HR, ILO and other organizations partnering with Yai.</p>
    </div></div>
  </div>
...
.rdslide .eyebrow{margin-bottom:10px}.rd{display:flex;justify-content:space-between;margin:0 -44px;gap:26px;align-items:flex-start}.rd-phones{width:320px}.rd-chat{flex:1;align-self:flex-start;padding:0 6px;margin-top:-18px;font-family:Arial,Helvetica,sans-serif;display:flex;flex-direction:column;gap:5px}.rd-sec{display:flex;align-items:flex-start;gap:10px}.rd-av{width:30px;height:30px;border-radius:50%;overflow:hidden;flex:none;box-shadow:0 3px 8px rgba(0,0,0,.4);margin-top:4px}.rd-av img{width:100%;height:100%;object-fit:cover;display:block;border:0;box-shadow:none;border-radius:50%}.rd-bub{position:relative;background:#F6F5F2;color:#0A1F47;border-radius:18px;border-top-left-radius:4px;padding:6px 12px 7px;box-shadow:0 8px 24px rgba(0,0,0,.35)}.rd-bub::before{content:"";position:absolute;left:-8px;top:10px;border:8px solid transparent;border-right-color:#F6F5F2;border-left:0}.rd-note-k{color:var(--orange);font-weight:700;font-size:11px;letter-spacing:2px;text-transform:uppercase;margin-bottom:2px}.rd-note-k .km{font-family:"Khmer Sangam MN","Noto Sans Khmer","Khmer OS",sans-serif;letter-spacing:0;font-size:16px;text-transform:none}.rd-chat h3{font-size:14.5px;line-height:1.2;margin:0 0 3px;color:#0A1F47}.rd-chat p{font-size:12px;line-height:1.32;margin:0;color:#334155}.rd-chat p b{color:#0A1F47}.phone.big{height:auto;padding:12px 10px;box-sizing:border-box}.scr{width:300px;border-radius:22px;overflow:hidden;background:#f6f6f6}.scr img{display:block;width:300px;border:0;box-shadow:none;border-radius:0}
