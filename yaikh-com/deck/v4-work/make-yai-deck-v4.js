...
<div class="rd">
  <div class="rd-phones"><div class="phone big"><div class="phone-notch"></div><div class="scr">
    ...
    <div class="vid-row">
      <div class="vid"><div class="vid-play">▶</div><div class="vid-cap">Phsar · Factory Services · Wholesale</div></div>
    ...
    <img class="scr-nav" src="${uri(path.join(LITE, "ui", "app-nav.jpg"))}" alt="">
  </div></div></div>
</div>
`, { cls: "rdslide" });
...
.vid-row{display:grid;grid-template-columns:auto 1fr;gap:8px;padding:6px 8px 4px;align-items:stretch}.vid{height:440px;width:247.5px;background:linear-gradient(160deg,#0A1F47,#1E4DAA);border-radius:10px;position:relative;display:flex;align-items:center;justify-content:center}.vid-play{width:56px;height:56px;font-size:24px;border-radius:50%;background:rgba(255,255,255,.92);color:var(--orange);font-size:18px;display:flex;align-items:center;justify-content:center;padding-left:3px}.vid-cap{position:absolute;bottom:10px;left:8px;right:8px;font-size:9px;color:#FFD58A;text-align:center}
.vcol{display:flex;flex-direction:column;justify-content:space-around}.vb{display:flex;flex-direction:column;align-items:center;gap:1px}.vb span{width:32px;height:32px;border-radius:50%;background:#fff;box-shadow:0 1px 3px rgba(0,0,0,.15);display:flex;align-items:center;justify-content:center;font-size:12px;color:var(--orange)}.vb small{font-size:7px;color:#334155}.rd h2{font-size:38px;margin:0 0 16px}.rd ul{margin:0;padding-left:22px;font-size:20px;line-height:1.45;color:#DCE4F5}.rd li{margin-bottom:9px}.rd li b{color:var(--gold)}.rd-note{margin:18px 0 0;font-size:16px;color:#8FA8D8}
