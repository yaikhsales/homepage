...
<div class="rd">
  <div class="rd-phones"><div class="phone big"><div class="phone-notch"></div><div class="scr">
    <img class="scr-top" src="${uri(path.join(LITE, "ui", "app-head.jpg"))}" alt="Yai app">
    <div class="vid-row">
