...
<div class="rd">
  ...
  <div class="rd-phones"><div class="phone big"><div class="phone-notch"></div><div class="scr chat">
    <div class="hd"><span class="hd-ic">‹</span><span class="hd-yai"><img src="${logo}" alt="Yai"></span><b>My Yai</b><small>online · ask me anything</small><span class="hd-sp"></span><span class="hd-ic">⋯</span></div>
    <div class="cbody">
      <div class="cday">Today</div>
      <div class="cb me">How many workers are absent today?</div>
      <div class="cb ai"><b>14 absent of 612</b> · 2.3%<br>Line 3 has 5 — that is your highest. Want the names?</div>
      <div class="cb me">Yes, and show line 3 efficiency</div>
      <div class="cb ai"><div class="ccard"><div class="cc-h">Line 3 · today</div><div class="cc-row"><span>Efficiency</span><b class="warn">71%</b></div><div class="cc-row"><span>Target</span><b>82%</b></div><div class="cc-row"><span>Output</span><b>1,240 / 1,800 pcs</b></div><div class="cc-row"><span>Absent</span><b>Sokha · Dara · Chanthy · Bopha · Rith</b></div></div>Shall I message the line supervisor?</div>
      <div class="cb me">Yes, send it</div>
      <div class="cb ai">✅ Sent to Mr. Vannak (Line 3) via Yai Chat.</div>
    </div>
    <div class="cin"><span class="cin-mic">🎤</span><span class="cin-box">Ask Yai… KH / EN / 中文</span><span class="cin-send"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12l16-8-6 16-2-7z"/></svg></span></div>
    <div class="snav">
      <div class="sn"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 11l9-7 9 7"/><path d="M5 10v10h14V10"/><path d="M10 20v-6h4v6"/></svg><span>Home</span></div>
      <div class="sn"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h6v6H4zM14 4h6v6h-6zM4 14h6v6H4zM14 14h6v6h-6z"/></svg><span>Services</span></div>
      <div class="sn on"><img src="${logo}" alt="Yai"><span>My Yai</span></div>
      <div class="sn"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="4"/><path d="M4 21a8 8 0 0 1 16 0"/></svg><span>Profile</span></div>
    </div>
  </div></div></div>
</div>
