...
.vid-row{display:grid;grid-template-columns:auto 1fr;gap:6px;padding:6px 8px 4px;align-items:stretch}.vid{height:280px;width:157.5px;background:#0A1F47;border-radius:10px;position:relative;display:flex;align-items:center;justify-content:center;overflow:hidden}.vid-bg{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;display:block;border:0;box-shadow:none;border-radius:0}.vid-holder{background:linear-gradient(160deg,#0A1F47,#1E4DAA);display:flex;flex-direction:column;align-items:center;justify-content:flex-start;padding-top:18px;gap:2px;color:#FFD58A;text-align:center}.vid-holder span{font-size:8px;font-weight:700}.vid-holder small{font-size:6.5px;color:#8FA8D8}.vid-side{position:absolute;right:5px;bottom:46px;display:flex;flex-direction:column;gap:7px;align-items:center;color:#fff;font-size:11px;text-shadow:0 1px 2px rgba(0,0,0,.6)}.vid-side span{display:flex;flex-direction:column;align-items:center;gap:1px;line-height:1}.vid-side b{font-size:5.5px;font-weight:700}.vid-meta{position:absolute;left:6px;right:30px;bottom:8px;color:#fff;text-shadow:0 1px 2px rgba(0,0,0,.7);display:flex;flex-direction:column;gap:2px}.vid-meta b{font-size:6.5px}.vid-meta span{font-size:6px;line-height:1.25}.vid:after{content:"";position:absolute;inset:0;background:linear-gradient(to top,rgba(0,0,0,.55),transparent 45%)}.vid-side,.vid-meta,.vid-play{z-index:2}.vid-play{width:32px;height:32px;font-size:14px;border-radius:50%;background:rgba(255,255,255,.85);color:var(--orange);font-size:18px;display:flex;align-items:center;justify-content:center;padding-left:3px}.vid-cap{position:absolute;bottom:6px;left:6px;right:6px;font-size:7px;color:#FFD58A;text-align:center}
