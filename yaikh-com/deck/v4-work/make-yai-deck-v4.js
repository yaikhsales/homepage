...
.hd{display:flex;align-items:center;gap:6px;padding:10px 12px 4px;font-family:Arial,Helvetica,sans-serif;color:#0A1F47}.hd b{font-size:13px}.hd small{font-size:9px;color:#94A3B8}.hd-sp{flex:1}.hd-av{width:26px;height:26px;border-radius:50%;background:linear-gradient(135deg,#F37021,#FFD58A)}.hd-ic{width:24px;height:24px;border-radius:50%;background:#EEECE7;display:flex;align-items:center;justify-content:center;font-size:11px}.hd-ic.flag{font-size:14px}.hd2{display:flex;align-items:center;gap:5px;padding:2px 12px 6px;font-size:8px;color:#64748B;font-family:Arial,Helvetica,sans-serif;white-space:nowrap}.hd2 em{font-style:normal;color:#CBD5E1}.hd-bar{width:54px;height:5px;border-radius:3px;background:#E8E6E1;overflow:hidden}.hd-bar i{display:block;width:0;height:100%;background:var(--orange)}.scr-bot{height:auto}.srow{display:grid;grid-template-columns:repeat(3,1fr);gap:7px;padding:8px 10px 0;background:#F6F5F2}.stile{background:#fff;border-radius:12px;height:66px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:5px;font:700 9.5px Arial,Helvetica,sans-serif;color:#0A1F47;box-shadow:0 1px 3px rgba(10,31,71,.06)}.stile img{width:34px;height:auto;display:block;border:0;box-shadow:none;border-radius:0}.sico{width:32px;height:32px;border-radius:50%;background:radial-gradient(circle at 35% 30%,#FF9A5C 0%,#F37021 45%,#C4501A 100%);box-shadow:0 3px 7px rgba(10,31,71,.3),inset 0 -2px 4px rgba(0,0,0,.25),inset 0 2px 3px rgba(255,255,255,.35);color:#fff;display:flex;align-items:center;justify-content:center}.sico svg{width:18px;height:18px;display:block;stroke:currentColor;fill:none;filter:drop-shadow(0 1px 1px rgba(0,0,0,.35))}.scr-nav{height:auto}
.vid-row{display:grid;grid-template-columns:auto 1fr;gap:6px;padding:6px 8px 4px;align-items:stretch}.vid{height:280px;width:157.5px;background:#0A1F47;border-radius:10px;position:relative;display:flex;align-items:center;justify-content:center;overflow:hidden}.vid-bg{position:absolute;inset:0;width:100%;height:100%;object-fit:contain;display:block;border:0;box-shadow:none;border-radius:0}.vid-holder{background:linear-gradient(160deg,#0A1F47,#1E4DAA);display:flex;flex-direction:column;align-items:center;justify-content:flex-start;padding-top:18px;gap:2px;color:#FFD58A;text-align:center}.vid-holder span{font-size:8px;font-weight:700}.vid-holder small{font-size:6.5px;color:#8FA8D8}.vid-side{position:absolute;right:5px;bottom:46px;display:flex;flex-direction:column;gap:7px;align-items:center;color:#fff;font-size:11px;text-shadow:0 1px 2px rgba(0,0,0,.6)}.vid-side span{display:flex;flex-direction:column;align-items:center;gap:1px;line-height:1}.vid-side b{font-size:5.5px;font-weight:700}.vid-meta{position:absolute;left:6px;right:30px;bottom:8px;color:#fff;text-shadow:0 1px 2px rgba(0,0,0,.7);display:flex;flex-direction:column;gap:2px}.vid-meta b{font-size:6.5px}.vid-meta span{font-size:6px;line-height:1.25}.vid:after{content:"";position:absolute;inset:0;background:linear-gradient(to top,rgba(0,0,0,.55),transparent 45%)}.vid-side,.vid-meta,.vid-play{z-index:2}.vid-play{width:32px;height:32px;font-size:14px;border-radius:50%;background:rgba(255,255,255,.85);color:var(--orange);font-size:18px;display:flex;align-items:center;justify-content:center;padding-left:3px}.vid-cap{position:absolute;bottom:6px;left:6px;right:6px;font-size:7px;color:#FFD58A;text-align:center}
