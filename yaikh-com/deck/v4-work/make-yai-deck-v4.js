...
.hd{display:flex;align-items:center;gap:6px;padding:10px 12px 4px;font-family:Arial,Helvetica,sans-serif;color:#0A1F47}.hd b{font-size:13px}.hd small{font-size:9px;color:#94A3B8}.hd-sp{flex:1}.hd-av{width:26px;height:26px;border-radius:50%;background:linear-gradient(135deg,#F37021,#FFD58A)}.hd-ic{width:24px;height:24px;border-radius:50%;background:#EEECE7;display:flex;align-items:center;justify-content:center;font-size:11px}.hd-ic.flag{font-size:14px}.hd2{display:flex;align-items:center;gap:5px;padding:2px 12px 6px;font-size:8px;color:#64748B;font-family:Arial,Helvetica,sans-serif;white-space:nowrap}.hd2 em{font-style:normal;color:#CBD5E1}.hd-bar{width:54px;height:5px;border-radius:3px;background:#E8E6E1;overflow:hidden}.hd-bar i{display:block;width:0;height:100%;background:var(--orange)}.scr-bot{height:auto}.scr-nav{height:auto}
.vid-row{display:grid;grid-template-columns:auto 1fr;gap:6px;padding:6px 8px 4px;align-items:stretch}.vid{height:280px;width:157.5px;background:linear-gradient(160deg,#0A1F47,#1E4DAA);border-radius:10px;position:relative;display:flex;align-items:center;justify-content:center}.vid-play{width:36px;height:36px;font-size:16px;border-radius:50%;background:rgba(255,255,255,.92);color:var(--orange);font-size:18px;display:flex;align-items:center;justify-content:center;padding-left:3px}.vid-cap{position:absolute;bottom:6px;left:6px;right:6px;font-size:7px;color:#FFD58A;text-align:center}
.vcol{display:flex;flex-direction:column;justify-content:space-around}.vb{display:flex;flex-direction:column;align-items:center;gap:1px}.vb{gap:0}.vb .vb-ic{width:40px;height:40px;border-radius:13px;background:#fff;box-shadow:0 2px 6px rgba(10,31,71,.12);display:flex;align-items:center;justify-content:center;color:var(--orange)}.vb .vb-ic svg{width:22px;height:22px;display:block;stroke:currentColor;fill:none}.vb.hot .vb-ic.yai{background:none;box-shadow:0 3px 8px rgba(243,112,33,.4);border-radius:50%;overflow:hidden;padding:0}.vb.hot .vb-ic.yai img{width:100%;height:100%;object-fit:cover;display:block;border:0;box-shadow:none;border-radius:50%}.vb small{font-size:8px;font-weight:700;color:#0A1F47;margin-top:3px}.vb em{font-style:normal;font-size:6.5px;color:#94A3B8}.rd h2{font-size:38px;margin:0 0 16px}.rd ul{margin:0;padding-left:22px;font-size:20px;line-height:1.45;color:#DCE4F5}.rd li{margin-bottom:9px}.rd li b{color:var(--gold)}.rd-note{margin:18px 0 0;font-size:16px;color:#8FA8D8}
