...
.vid-row{display:grid;grid-template-columns:40px 1fr 40px;gap:4px;padding:4px 6px;align-items:stretch}.vid{height:176px;background:linear-gradient(160deg,#0A1F47,#1E4DAA);border-radius:10px;position:relative;display:flex;align-items:center;justify-content:center}.vid-play{width:36px;height:36px;border-radius:50%;background:rgba(255,255,255,.92);color:var(--orange);font-size:18px;display:flex;align-items:center;justify-content:center;padding-left:3px}.vid-cap{position:absolute;bottom:6px;left:6px;right:6px;font-size:7px;color:#FFD58A;text-align:center}
.vcol{display:flex;flex-direction:column;justify-content:space-around}.vb{display:flex;flex-direction:column;align-items:center;gap:1px}.vb span{width:28px;height:28px;border-radius:50%;background:#fff;box-shadow:0 1px 3px rgba(0,0,0,.15);display:flex;align-items:center;justify-content:center;font-size:12px;color:var(--orange)}.vb small{font-size:6px;color:#334155}.rd h2{font-size:38px;margin:0 0 16px}.rd ul{margin:0;padding-left:22px;font-size:20px;line-height:1.45;color:#DCE4F5}.rd li{margin-bottom:9px}.rd li b{color:var(--gold)}.rd-note{margin:18px 0 0;font-size:16px;color:#8FA8D8}
