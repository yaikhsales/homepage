...
<h2><i>Almost every “factory” still runs on paper and chat apps.</i></h2>
...
<h2>Every business in Cambodia is a Yai customer. We start with the biggest 1,700 factories.</h2>
<p class="sub">Our serviceable market: 1,700 soft-goods exporters · 5,000 non-manufacturing businesses · 6,000 small factories.</p>
<div class="stat3">
...
<p class="rival-line">Built for Adidas only — sell it, and Nike and Under Armour copy it and the edge is gone. It moves material from mills → factories → shipment → shop racks; it doesn't run the factory floor.<br><b>No AIoT · no Ai PAs · no Big Brain. Yai has all three — for every brand, from $120 a year.</b></p>
