...
<div class="rd">
  <div class="rd-phones"><div class="phone big"><div class="phone-notch"></div><div class="scr">
    ...
    <div class="srow">
      <div class="stile"><img src="${uri(path.join(LITE, "ui", "ico-scan.jpg"))}" alt=""><span>Scan</span></div>
