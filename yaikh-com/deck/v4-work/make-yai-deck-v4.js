...
<div class="rd">
  ...
  <div class="rd-note">
    ...
    <p>Short clips play right on the home screen — TikTok-style, in Khmer. The company posts its own: onboarding, safety, quality, HR notices. Organizations post theirs too — TAFTAC, brands, auditors and government programmes — so every worker gets the message on their own phone.</p>
    <ul>
      <li><b>Company feed</b> — training, SOPs, announcements, recognition</li>
      <li><b>Organization feed</b> — TAFTAC, brand compliance, ILO / NSSF awareness</li>
      <li><b>Yai tracks it</b> — who watched, who finished, what to repeat</li>
    </ul>
  </div>
...
.rdslide .eyebrow{margin-bottom:10px}.rd{display:flex;justify-content:space-between;margin:0 -44px;gap:26px;align-items:flex-start}.rd-phones{width:320px}.rd-note{flex:1;align-self:center;padding:0 10px;color:#fff;font-family:Arial,Helvetica,sans-serif}.rd-note-k{color:var(--orange);font-weight:700;font-size:15px;letter-spacing:2px;text-transform:uppercase;margin-bottom:10px}.rd-note h3{font-size:26px;line-height:1.2;margin:0 0 14px;color:var(--gold)}.rd-note p{font-size:16px;line-height:1.45;margin:0 0 14px;color:#DDE3EE}.rd-note ul{margin:0;padding-left:18px;font-size:15px;line-height:1.5;color:#DDE3EE}.rd-note li b{color:#fff}.phone.big{height:auto;padding:12px 10px;box-sizing:border-box}.scr{width:300px;border-radius:22px;overflow:hidden;background:#f6f6f6}.scr img{display:block;width:300px;border:0;box-shadow:none;border-radius:0}
