...
<div class="rd">
  <div class="rd-phones"><div class="phone big"><div class="phone-notch"></div><img src="${uri(path.join(LITE, "ui", "app-market.jpg"))}" alt="Yai app"></div></div>
</div>
`, { cls: "rdslide" });
