      ...
      >
        ...
        <div className="relative w-[420px] h-[92vh] max-h-[900px] bg-black rounded-[3rem] p-3 shadow-2xl border-8 border-gray-900 flex flex-col">
          ...
          <div className="w-full h-full bg-white rounded-[2.5rem] overflow-hidden flex flex-col relative">
              ...
              <div className="flex flex-col h-full">
                ...
                <div className="p-3 border-b border-gray-200">
                  <button
                    ...
                    className={`w-full flex items-center gap-2 px-3 py-2 rounded-full bg-gradient-to-r ${accountingTopic ? "from-green-100 to-emerald-100" : "from-orange-100 to-amber-100"} border border-gray-200 hover:opacity-80 transition shadow-sm`}
                  >
            ...
            {/* Header — Accounting PA palette (green/emerald) when accounting
                topic active, falls back to the legacy orange theme otherwise.
                This visually unifies the floating chat with the centered
                BotModules Accounting PA so the user sees ONE PA, not two. */}
            <div className={`flex items-center justify-between p-4 border-b border-gray-200 bg-gradient-to-r ${accountingTopic ? "from-green-500 to-emerald-500" : "from-orange-500 to-amber-500"} relative z-10 flex-shrink-0`}>
            ...
            <div className="flex-1 overflow-y-auto p-4 bg-gray-50 relative z-10">
              {messages.length === 0 && (
                <div className="flex flex-col items-center justify-center h-full text-center px-4">
                  <div className={`w-16 h-16 rounded-full bg-gradient-to-r ${accountingTopic ? "from-green-500 to-emerald-500" : "from-orange-500 to-amber-500"} flex items-center justify-center mb-4`}>
                      ...
                      {msg.text.split("\n").map((line, lineIndex, array) => {
                        ...
                        if (
                          ...
                          return (
                            ...
                            >
                              <span
                                className={`mt-0.5 flex-shrink-0 ${msg.from === "user" ? "text-white" : (accountingTopic ? "text-emerald-500" : "text-orange-500")}`}
                              >
                                •
                              </span>
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex-1 flex items-center gap-2 bg-gray-100 rounded-full px-4 py-2">
                  <input
                    ...
                    placeholder={accountingTopic ? `Ask about ${accountingTopic}` : "Ask me anything..."}
