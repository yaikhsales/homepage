...
`);
    ...
    const takes = [
      ...
      { at: 0.55, side: "below", dx: 0, dy: 0, y: "Aug – Oct 2026", d: "First 3 paying clients: BICNZ · 3SGS · ES Packing · first public expos and events" },
...
<div class="road">
  <svg viewBox="0 0 1160 590" xmlns="http://www.w3.org/2000/svg">
    ...
    <path id="roadpath" d="M 30 400 C 330 400, 300 250, 580 250 S 830 200, 1130 190" fill="none" stroke="#C9D3E3" stroke-width="54" stroke-linecap="round" filter="url(#rs)"/>
    <path d="M 30 400 C 330 400, 300 250, 580 250 S 830 200, 1130 190" fill="none" stroke="#fff" stroke-width="3" stroke-dasharray="18 14" opacity=".9"/>
    <g id="pins"></g>
  </svg>
