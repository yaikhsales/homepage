...
<div class="rd">
  <div class="rd-phones"><div class="phone big"><div class="phone-notch"></div><div class="scr">
    ...
    <div class="vid-row">
      <div class="vcol"><div class="vb"><span>▶</span><small>Play</small></div><div class="vb"><span>♡</span><small>Like</small></div><div class="vb"><span>↗</span><small>Share</small></div><div class="vb"><span>＋</span><small>Save</small></div></div>
...
.vid-row{display:grid;grid-template-columns:1fr auto 1fr;gap:6px;padding:4px 8px;align-items:stretch}.vid{height:236px;width:132.75px;background:linear-gradient(160deg,#0A1F47,#1E4DAA);border-radius:10px;position:relative;display:flex;align-items:center;justify-content:center}.vid-play{width:36px;height:36px;border-radius:50%;background:rgba(255,255,255,.92);color:var(--orange);font-size:18px;display:flex;align-items:center;justify-content:center;padding-left:3px}.vid-cap{position:absolute;bottom:6px;left:6px;right:6px;font-size:7px;color:#FFD58A;text-align:center}
