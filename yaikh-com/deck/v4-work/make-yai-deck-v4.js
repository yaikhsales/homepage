...
<div class="hiw">
  ...
  <figure class="hiw-app"><img src="${uri(path.join(LITE, "ui", "app-home.jpg"))}" alt="Yai app UI"></figure>
  <div class="hiw-aiot"><div class="hiw-aiot-h">AIoT</div>
...
.hiwslide .eyebrow{margin-bottom:14px;letter-spacing:.1em;white-space:nowrap}.hiw{display:grid;grid-template-columns:5.6fr 2.2fr 2.2fr;gap:16px;align-items:start}.hiw figure{margin:0}.hiw img{display:block;border-radius:10px;border:2px solid rgba(255,255,255,.18);box-shadow:0 10px 30px rgba(0,0,0,.4)}.hiw-web img{width:100%;max-height:585px;object-fit:cover;object-position:top}.hiw-app img{width:100%;max-height:585px;object-fit:cover;object-position:top}.hiw figcaption{margin-top:8px;font-size:16px;line-height:1.3;color:#DCE4F5}.hiw figcaption b{display:block;color:var(--gold);font-size:19px;margin-bottom:2px}.hiw-aiot{border:1px solid rgba(255,213,138,.35);border-radius:12px;padding:10px 12px 12px;height:585px;display:flex;flex-direction:column;gap:6px}.hiw-aiot-h{font-size:19px;font-weight:800;color:var(--gold);letter-spacing:.12em;text-transform:uppercase}.hiw-aiot figure{margin:0;flex:1;min-height:0;display:flex;flex-direction:column}.hiw-aiot figure img{flex:1;min-height:0;width:100%;object-fit:cover;border-radius:8px;border:1px solid rgba(255,255,255,.14)}.hiw-aiot figcaption{font-size:13px;color:#DCE4F5;margin-top:3px;text-align:center;white-space:nowrap}.hiw-aiot p{margin:0;font-size:15px;color:#8FA8D8;line-height:1.3}
