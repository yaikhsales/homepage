...
.rdslide .eyebrow{margin-bottom:10px}.rd{display:flex;justify-content:space-between;margin:0 -44px;gap:26px;align-items:flex-start}.rd-phones{width:320px}.rd-note{flex:1;align-self:center;padding:0 8px;color:#fff;font-family:Arial,Helvetica,sans-serif;display:flex;flex-direction:column;gap:26px}.rd-note-k{color:var(--orange);font-weight:700;font-size:14px;letter-spacing:2px;text-transform:uppercase;margin-bottom:8px}.rd-note-k .km{font-family:"Khmer Sangam MN","Noto Sans Khmer","Khmer OS",sans-serif;letter-spacing:0;font-size:18px;text-transform:none}.rd-note h3{font-size:22px;line-height:1.2;margin:0 0 10px;color:var(--gold)}.rd-note p{font-size:15px;line-height:1.45;margin:0;color:#DDE3EE}.phone.big{height:auto;padding:12px 10px;box-sizing:border-box}.scr{width:300px;border-radius:22px;overflow:hidden;background:#f6f6f6}.scr img{display:block;width:300px;border:0;box-shadow:none;border-radius:0}
