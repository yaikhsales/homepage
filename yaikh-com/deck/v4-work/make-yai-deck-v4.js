...
`);
    ...
    const nodes = {
      T1: { x: 70,  y: 470, kind: "take", side: "right", dx: 0, dy: 26, y2: "2024 – 25", d: "pre-revenue development" },
      S5: { x: 70,  y: 522, kind: "sub", side: "right", dx: 0, dy: 0, d: "70+ apps" },
      S6: { x: 70,  y: 554, kind: "sub", side: "right", dx: 0, dy: 0, d: "14 Ai agents" },
      M1: { x: 180, y: 400, kind: "mile", side: "above", dx: 0,   dy: 0,  y2: "2025", t: "Incorporation", d: "Texlink Technologies · Oct 2025" },
      T2: { x: 320, y: 330, kind: "take", side: "right", dx: 0, dy: 26, y2: "Feb 2026", d: "" },
      S7: { x: 320, y: 392, kind: "sub", side: "right", dx: 0, dy: 0, d: "21-factory implementation with Yorkwell" },
      ...
      S1: { x: 610, y: 350, kind: "sub", side: "right", dx: 0, dy: 0, d: "BICNZ — calibration service" },
      S2: { x: 610, y: 388, kind: "sub", side: "right", dx: 0, dy: 0, d: "3SGS — Ai compliance platform" },
      S3: { x: 610, y: 430, kind: "sub", side: "right", dx: 0, dy: 0, d: "ES Packing —<br>administrative applications" },
      S4: { x: 610, y: 470, kind: "sub", side: "right", dx: 0, dy: 0, d: "First public expos & events" },
    ...
    // circuit traces: orthogonal + 45° bends between nodes, plus vertical drop chains
    const traces = [
      ...
      "M70 470 V554", "M320 330 V426", "M610 250 V470", "M880 250 V414",   // drop chains
    ];
...
(function(){
  ...
  Object.values(nodes).forEach((m) => {
    ...
    const rx = m.side === "right" ? 16 : 0;
    el.style.left = ((m.x + m.dx + rx) / 1160 * 100) + "%"; el.style.top = ((m.y + m.dy) / 590 * 100) + "%";
